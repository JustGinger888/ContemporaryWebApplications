...
function SignInButton() {
  ...
  return (
    <button className="inline-block w-full px-5 py-4 mt-3 text-lg font-bold text-center text-gray-900 transition duration-200 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 ease" onClick={signInWithGoogle}>
      Sign in with Google
    </button>
  );
}
