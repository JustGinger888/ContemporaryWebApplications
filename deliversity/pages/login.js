            ...
            <div class=" hidden lg:block relative h-screen w-full bg-cover lg:w-6/12 xl:w-7/12 bg-gradient-to-r from-white via-white to-gray-100">
              <div class="relative flex flex-col items-center justify-center w-full h-full px-10 my-20 lg:px-16 lg:my-0">
                <div class="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
                  ...
                  <a
                    href="#_"
                    class="inline-block px-8 py-5 text-xl font-medium text-center text-white transition duration-200 bg-red-500 rounded-lg hover:bg-red-600 ease"
                  >
                    Get Started Today
                  </a>
                </div>
            ...
            <div class="w-full  bg-white lg:w-6/12 xl:w-5/12">
              <div class="flex  flex-col items-left justify-center w-full h-screen p-10 lg:p-16 xl:p-24">
                ...
                <p class="text-lg text-gray-500">
                  ...
                  <a href="#_" class="text-red-500 underline">
                    sign in
                  </a>
                </p>
                <div class="relative w-full mt-10 space-y-8">
                  <div class="relative">
                    ...
                    <input
                      type="text"
                      class="block w-full px-4 py-4 mt-2 text-xl placeholder-gray-400 bg-gray-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-red-500 focus:ring-opacity-50"
                  ...
                  <div class="relative">
                    <a
                      href="#_"
                      class="inline-block w-full px-5 py-4 text-lg font-medium text-center text-white transition duration-200 bg-red-500 rounded-lg hover:bg-red-600 ease"
                    >
                      Create Account
                    </a>
                    <a
